...
This privacy policy applies to the Agentic Ai for enterprises app for mobile devices, together with any related services operated by Dhana Shekhar Tontanahal (collectively, the "Application"). Dhana Shekhar Tontanahal is hereby referred to as the "Service Provider".
